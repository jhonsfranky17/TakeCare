...
const variants: Record<ButtonVariant, CSSProperties> = {
  // The single most important control in the app: 64px, lima 400.
  primary: {
    height: 'var(--tc-h-cta)',
...
const pressed: Record<ButtonVariant, CSSProperties> = {
  primary: { background: 'var(--tc-cta-pressed)', color: '#FFFFFF', boxShadow: 'none' },
...
export function Button({
  ...
  return (
    <button
      ...
      style={{ ...base, ...variants[variant], ...(down ? pressed[variant] : null), ...style }}
      {...rest}
    >
      {children}
    </button>
